          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <i>WITHDRAWAL ORDER [BALANCE: ₦<?php echo number_format($max->wallet($uid),2) ?>]</i>
              </div>
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="amount" min="<?php echo $max->minwithdraw ?>" max="<?php echo $max->wallet($uid)-1 ?>" class="form-control" placeholder="amount (in naira)" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                  ...
                  <div class="col-md-4">
                     <input type="submit" name="RequestWithdrawal" class="btn btn-primary" value="INITIATE WITHDRAWAL">
                </div>
                </div>
              </form>
              </div>
