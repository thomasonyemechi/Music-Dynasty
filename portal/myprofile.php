                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    <div class="text-center">
                      <img class="img-circle elevation-2 w-50" src="images/<?php echo userName($uid, 'photo'); ?>" alt="User profile picture">
                    </div>
                ...
                <form method="post">
                  <div class="card-body">
                    <table class="table table-bordered table-striped ">
                      <tr>
                        <th>Firstname</th>
                        <td><?php echo userName($uid, 'firstname'); ?></td>
                      </tr>
                      <tr>
                        <th>Lastname</th>
                        <td><?php echo userName($uid, 'lastname'); ?></td>
                      </tr>

                      <tr>
                        <th>Phone Number</th>
                        <td><?php echo userName($uid, 'phone'); ?></td>
                      </tr>
                      <tr>
                        <th>Gender</th>
                        <td><?php echo userName($uid, 'sex'); ?></td>
                      </tr>
                      <tr>
                        <th>State</th>
                        <td><?php echo userName($uid, 'state'); ?></td>
                      </tr>
                      <tr>
                        <th>Country</th>
                        <td><?php echo userName($uid, 'country'); ?></td>
                      </tr>
                      <tr>
                        <th>account name</th>
                        <td><?php echo userName($uid, 'accname'); ?></td>
                      </tr>
                      <tr>
                        <th>account number</th>
                        <td><?php echo userName($uid, 'accountno'); ?></td>
                      </tr>
                      <tr>
                        <th>bank</th>
                        <td><?php echo userName($uid, 'bank'); ?></td>
                      </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <div class="card-header">
                      ...
                      <form method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <input type="password" placeholder="" name="currentpass" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="example-email" class="col-md-12">New Password</label>
                          <div class="col-md-12">
                            <input type="password" placeholder="" class="form-control" name="newpass" id="example-email">
                          </div>
                        </div>
                        <div class="form-group">
          ...
          <div class="modal-body">
            <div class="form-group">
              <form method="post">
                ...
                <div class="col-md-12">
                  <input type="text" name="accname" class="form-control" value="<?php echo userName($uid, 'accname') ?>">
                </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">Account Number</label>
              <div class="col-md-12">
                <input type="text" name="accountno" class="form-control" value="<?php echo userName($uid, 'accountno') ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">Bank Name</label>
              <div class="col-md-12">
                <input type="text" name="bank" class="form-control" value="<?php echo userName($uid, 'bank') ?>">
              </div>
            </div>
        ...
        <div class="modal-body">
          <form method="post">
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" name="firstname" class="form-control" value="<?php echo userName($uid, 'firstname') ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">last name</label>
              <div class="col-md-12">
                <input type="text" name="lastname" class="form-control" value="<?php echo userName($uid, 'lastname') ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">Gender</label>
              <div class="col-md-12">
                <input type="text" name="sex" class="form-control" value="<?php echo userName($uid, 'sex') ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">Phone Number</label>
              <div class="col-md-12">
                <input type="text" name="phone" class="form-control" value="<?php echo userName($uid, 'phone') ?>">
              </div>
            </div>
            <div class="form-group">
